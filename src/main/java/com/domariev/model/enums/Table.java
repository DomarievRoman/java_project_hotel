...
public enum Table {
    ...
    EMPLOYEE("CREATE TABLE IF NOT EXISTS employee(employeeId long NOT NULL AUTO_INCREMENT PRIMARY KEY, " +
            "nameSurname varchar(255), profession varchar(255), salary int, hotelId long, FOREIGN KEY(hotelId) REFERENCES hotel(id) ON DELETE CASCADE);"),
    ROOM("CREATE TABLE IF NOT EXISTS room(roomId long NOT NULL AUTO_INCREMENT PRIMARY KEY," +
            ...
            " hotelId long, FOREIGN KEY(hotelId) REFERENCES hotel(id) ON DELETE CASCADE);");
