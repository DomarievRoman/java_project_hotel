...
<header>
    <div class="room_header">
        <nav class="navbar navbar-expand-lg">
            <a class="navbar-brand">ROOMS IN HOTEL</a>
...
<table class="table table-bordered table-hover">
    ...
    <tr>
        ...
        <td>${room.price}</td>
        <td>${room.hotel}</td>
        <td><a href="MainServlet?action=edit_room&id=<c:out value = "${room.id}"/>"><img class="button"
                                                                                         src=${pageContext.request.contextPath}/resources/img/edit.png></a>
            <a href="MainServlet?action=delete_room&id=<c:out value = "${room.id}"/>"><img class="button"
